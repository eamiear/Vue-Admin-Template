  ...
  <div class='menu-wrapper'>
    <template v-for="item in routes">
      ...
      <router-link v-if="!item.hidden&&item.noDropdown&&item.children.length>0" :to="item.path+'/'+item.children[0].path">
        <el-menu-item :index="item.path+'/'+item.children[0].path" class='submenu-title-noDropdown treeview'>
          <a href="javascript:;">
      ...
      <el-submenu :index="item.name" v-if="!item.noDropdown&&!item.hidden" class="">
        <template slot="title">
        ...
        <template v-for="child in item.children" v-if='!child.hidden'>
          ...
          <router-link v-else :to="item.path+'/'+child.path">
            <el-menu-item :index="item.path+'/'+child.path" class='treeview'>
              <a href="javascript:;">
